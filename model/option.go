...
func InitOptionMap() {
	...
	common.OptionMap["VideoInputRatio"] = `{
...
}` // FEIXIANG_VIDEO_PRICING_ADMIN_PERSIST_V1_OPTION_DEFAULT // FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_OPTION_DEFAULT
	common.OptionMap["VideoResolutionPricing"] = DefaultVideoResolutionPricingJSONString() // FEIXIANG_VIDEO_RESOLUTION_PRICING_V1_OPTION_DEFAULT
...
func UpdateOption(key string, value string) error {
	if key == "VideoResolutionPricing" { // FEIXIANG_VIDEO_RESOLUTION_PRICING_V1_UPDATEOPTION_VALIDATE
		if err := ValidateVideoResolutionPricingJSONString(value); err != nil {
			return err
		}
	}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "VideoInputRatio":
		// FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_OPTION_UPDATE
		common.OptionMap["VideoInputRatio"] = value
	case "VideoResolutionPricing":
		// FEIXIANG_VIDEO_RESOLUTION_PRICING_V1_OPTION_UPDATE
		err = ValidateVideoResolutionPricingJSONString(value)
		if err == nil {
			common.OptionMap["VideoResolutionPricing"] = value
