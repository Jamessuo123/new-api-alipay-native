...
const createModelSchema = (t: Translate) =>
  z.object({
    ...
    VideoResolutionPricing: createJsonStringField(t),
...
export function RatioSettingsCard({
  ...
  const modelNormalizedDefaults = useRef({
    ...
    VideoResolutionPricing: normalizeJsonString(
      modelDefaults.VideoResolutionPricing
    ),
  ...
  const modelForm = useForm<ModelFormValues>({
    ...
    defaultValues: {
      ...
      VideoResolutionPricing: formatJsonForTextarea(
        modelDefaults.VideoResolutionPricing
      ),
  ...
  const saveModelRatios = useCallback(
    async (values: ModelFormValues) => {
      const normalized = {
        ...
        VideoResolutionPricing: normalizeJsonString(values.VideoResolutionPricing),
