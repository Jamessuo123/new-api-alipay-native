...
export const createModelPricingSchema = (t: (key: string) => string) =>
  z.object({
    ...
    videoInputRatio: z.string().optional(), // FEIXIANG_VIDEO_DUAL_PRICE_FINAL_SCHEMA
  })
...
// FEIXIANG_VIDEO_DUAL_PRICE_V4_CORE_HELPER
// 视频模型后台定价：ModelRatio = 无视频输入价格；VideoInputRatio = 含视频输入价格。
export const FEIXIANG_VIDEO_DUAL_PRICE_MODEL_RE_V4 =
  /(seedance|veo|kling|sora|wan|hailuo|skyreels|video)/i

export function isFeiXiangVideoInputPricingModelV4(
  modelName?: string | null
): boolean {
...
// FEIXIANG_VIDEO_DUAL_PRICE_V2_CORE
// 视频模型后台定价：ModelRatio = 无视频输入价格；VideoInputRatio = 含视频输入价格。
export const FEIXIANG_VIDEO_DUAL_PRICE_MODEL_RE_V2 =
  /(seedance|veo|kling|sora|wan|hailuo|skyreels|video)/i

export function isFeiXiangVideoInputPricingModelV2(
  modelName?: string | null
): boolean {
  return FEIXIANG_VIDEO_DUAL_PRICE_MODEL_RE_V2.test(String(modelName || ''))
}
...
export type ModelRatioData = {
  ...
  videoInputRatio?: string // FEIXIANG_VIDEO_DUAL_PRICE_FINAL_DATA_FIELD
...
export function buildPreviewRows(
  ...
  return [
    ...
    ...(values.videoInputRatio
      ? [
          {
            key: 'videoInputPrice',
            label: '含视频输入价格',
            value: `$${values.videoInputRatio}`,
          },
        ]
      : []), // FEIXIANG_VIDEO_DUAL_PRICE_FINAL_PREVIEW
    {
      key: 'completion',
