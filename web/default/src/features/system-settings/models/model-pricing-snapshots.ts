...
export type ModelPricingSnapshotInput = {
  ...
  videoInputRatio: string // FEIXIANG_VIDEO_DUAL_PRICE_FINAL_SNAPSHOT_INPUT
  billingMode: string
  billingExpr: string
}
...
export type ModelPricingSnapshot = {
  ...
  audioRatio?: string
  audioCompletionRatio?: string
  videoInputRatio?: string // FEIXIANG_VIDEO_DUAL_PRICE_FINAL_SNAPSHOT_FIELD
  billingMode?: string
  billingExpr?: string
...
export const buildModelSnapshots = ({
  ...
  const videoInputRatioMap = safeJsonParse<Record<string, number>>(
    videoInputRatio,
    { fallback: {}, context: 'video input ratios' }
  )
  ...
  const modelNames = new Set([
    ...
    ...Object.keys(videoInputRatioMap),
  ...
  return Array.from(modelNames).map((name) => {
    ...
    const videoInput = videoInputRatioMap[name]?.toString() || ''
