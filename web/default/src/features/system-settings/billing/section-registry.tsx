...
const getModelDefaults = (settings: BillingSettings) => ({
  ...
  VideoInputRatio: settings.VideoInputRatio, // FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_SECTION_REGISTRY
  VideoResolutionPricing: settings.VideoResolutionPricing ?? '{}', // FEIXIANG_VIDEO_RESOLUTION_PRICING_V4_SECTION_REGISTRY
