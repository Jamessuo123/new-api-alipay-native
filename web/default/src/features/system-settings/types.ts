...
export type ModelSettings = {
  ...
  VideoInputRatio: string // FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_SETTINGS_TYPE
  VideoResolutionPricing: string // FEIXIANG_VIDEO_RESOLUTION_PRICING_V4_SETTINGS_TYPE
