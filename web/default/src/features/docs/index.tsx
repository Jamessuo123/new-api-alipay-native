      ...
      blocks: [
        ...
        },
        {
          ...
          code: lines([
            ...
            'from openai import OpenAI',
            '',
            `client = OpenAI(api_key="sk-your-key", base_url="${v1}")`,
            '',
      ...
      blocks: [
        {
          ...
          headers: ['软件 / 场景', '填写方式'],
          rows: [
            ['Cherry Studio / Chatbox / NextChat / LobeChat', <><Code>Provider: OpenAI Compatible</Code><br /><Code>Base URL: {v1}</Code><br /><Code>API Key: sk-your-key</Code></>],
            ['Open WebUI', <><Code>OPENAI_API_BASE_URL={v1}</Code><br /><Code>OPENAI_API_KEY=sk-your-key</Code></>],
      ...
      blocks: [
        {
          ...
          code: lines([
            '令牌三步自检：',
            `1. curl ${v1}/models -H "Authorization: Bearer sk-your-key"`,
          ...
          <div className="fx-docs-hero-inner">
            ...
            <div className="fx-docs-quick-grid">
              ...
              <div className="fx-docs-quick-card">
                ...
                <div className="fx-docs-quick-value">sk-your-key</div>
              </div>
              <div className="fx-docs-quick-card">
        ...
        <section className="fx-docs-layout">
          ...
          <article className="fx-docs-content">
            ...
            <footer className="fx-docs-footer">
              © 2026 {SITE_NAME}. 本文档示例中的 <Code>sk-your-key</Code> 为占位符，请替换为你在控制台创建的真实令牌。
            </footer>
          </article>
        </section>
      </main>
