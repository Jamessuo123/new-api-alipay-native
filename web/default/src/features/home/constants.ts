...
export const MAIN_BASE_CLASSES = 'fx-home-page bg-background text-foreground w-full'
...
export const DEFAULT_STATS = [
  {
    value: '50',
    suffix: '+',
    description: 'major model providers integrated',
  },
  {
    value: '100',
    suffix: '+',
    description: 'models available through one API',
  },
  {
    value: '50',
    suffix: '+',
    description: 'OpenAI-compatible API routes',
  },
  {
    value: '10',
    suffix: '+',
    description: 'routing and cost controls',
  },
] as const
...
export const DEFAULT_FEATURES = [
  ...
  {
    title: 'FeiXiangApi Ready',
    description: 'A production-ready AI API gateway for developers and teams',
