...
const extendedModelFormSchema = z.object({
  ...
  videoInputRatio: z.string().optional(), // FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_DRAWER_SCHEMA
})
...
export function ModelMutateDrawer({
  ...
  const feiXiangVideoPricingName = form.watch('name') || ''
  const feiXiangIsVideoPricingModel = /^seedance-2\.0/i.test(feiXiangVideoPricingName)
  ...
  const modelSettings = useMemo(() => {
    ...
    const defaultModelSettings: ModelSettings = {
      ...
      VideoInputRatio: '', // FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_DRAWER_SETTING
  ...
  const form = useForm<ExtendedModelFormValues>({
    ...
    defaultValues: {
      ...
      audioRatio: '',
      audioCompletionRatio: '',
      videoInputRatio: '', // FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_DRAWER_DEFAULT
    },
  })
      ...
      if (modelSettings) {
        ...
        if (price !== undefined && price !== null) {
          ...
          form.reset({
            ...
            videoInputRatio: videoInputRatio?.toString() || '', // FEIXIANG_VIDEO_INPUT_RATIO_PRICING_V1_DRAWER_LOAD
          })
          setAdvancedOpen(
