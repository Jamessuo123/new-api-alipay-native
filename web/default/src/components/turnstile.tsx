...
export function Turnstile({
  ...
  return (
    <div
      className={`w-[min(100%,420px)] rounded-2xl border border-white/10 bg-white/[0.04] p-3 shadow-[0_16px_48px_rgba(0,0,0,0.28)] backdrop-blur-xl ${className}`}
    >
      ...
      <div className='mt-3 flex justify-center overflow-hidden'>
          <div
            ref={ref}
            className='fx-turnstile-widget-shell w-[300px] max-w-full overflow-hidden rounded-xl border border-white/10 bg-[#1f1f1f]'
          />
        </div>
