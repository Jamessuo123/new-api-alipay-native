...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/quota-packages': { section: 'personal', module: 'quota_packages' },
  '/dashboard/invite-rewards': {
    section: 'personal',
    module: 'invite_rewards',
  },
  ...
  '/quota-package-plans': { section: 'admin', module: 'quota_package' },
